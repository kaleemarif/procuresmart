...
useEffect(() => {
try {
const savedFarmer = localStorage.getItem(
"procuresmart_farmer_id",
);

  const savedBooking = localStorage.getItem(
    "procuresmart_active_booking",
  );

  if (savedFarmer) {
    setFarmerId(savedFarmer);
  }

  if (savedBooking) {
    const parsed = JSON.parse(savedBooking) as Booking;

    if (parsed?.booking_id && parsed?.token) {
      setBooking(parsed);
    }
  }
} catch {}
...
if (!centre?.centre_id) {
setError("Recommended centre is unavailable.");
setScreen("error");
return;
}
...
try {
  ...
  const available = (result?.slots ?? []).filter(
    (slot: Slot) => slot.remaining > 0,
  );

  setSlots(available);

  setSelectedSlot(
    available.find((slot: Slot) => slot.recommended) ??
      available[0] ??
      null,
  );
  ...
  setError(
    err instanceof Error
      ? err.message
      : "Unable to load procurement slots.",
  );
...
<div className="mx-auto min-h-screen w-full max-w-md bg-[#f7f4ec] shadow-sm">
    ...
    {screen === "dashboard" && (
      <section className="min-h-screen px-5 pb-8 pt-5">
        ...
        {activeBooking && (
          <div className="mt-6 rounded-[26px] border border-[#b9cdbd] bg-[#e8f0e9] p-5">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[#52715b]">
                  Active procurement
                </p>

                <h2 className="mt-1 text-2xl font-bold text-[#18352a]">
                  Token {activeBooking.token}
                </h2>
              </div>

              <span className="rounded-full bg-white px-3 py-1 text-xs font-bold text-[#24543d]">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
              <div>
                <div className="text-xs text-[#728077]">
                  Centre
                </div>

                <div className="font-semibold">
                  {activeBooking.centre_id}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="font-semibold">
                  {activeBooking.slot_start?.slice(
                    0,
                    5,
                  )}
                  –
                  {activeBooking.slot_end?.slice(
                    0,
                    5,
                  )}
                </div>
              ...
              <div>
                ...
                <div className="font-semibold">
                  {activeBooking.quantity_quintals} qtl
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className="mt-4 h-11 w-full rounded-xl border border-[#b8cabb] bg-white text-sm font-semibold text-[#24543d]"
            >
              View Token & Status
            </button>
          </div>
        ...
        <div className="mt-6">
          ...
          <p className="mt-3 text-sm leading-6 text-[#667169]">
            Get a recommendation based
            on expected waiting time, queue,
      ...
      <section className="min-h-screen px-5 py-5">
        ...
        <div className="mt-16">
          ...
          <p className="mt-4 text-sm leading-6 text-[#667169]">
            ...
            procurement data to demonstrate
            how intelligent centre
          ...
          <button
            ...
            className="mt-7 h-14 w-full rounded-2xl bg-[#1f513a] text-base font-semibold text-white"
          >
            Continue
          </button>
        </div>
      ...
      <section className="min-h-screen px-5 py-5">
        ...
        <div className="mt-10">
          ...
          <button
            ...
            className="mt-6 flex h-14 w-full items-center justify-center gap-3 rounded-2xl bg-[#1f513a] text-base font-semibold text-white disabled:opacity-40"
          >
            Continue
    ...
    {screen === "quantity" && (
      <section className="min-h-screen px-5 py-5">
        ...
        <div className="mt-12">
          ...
          <p className="mt-3 text-sm text-[#667169]">
            Enter the approximate quantity
            in quintals.
          </p>
          ...
          <div className="mt-12 flex items-center justify-between rounded-[28px] border border-[#d4ddd5] bg-white p-4">
            <button
              ...
              className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#edf2ed] text-[#24543d] disabled:opacity-40"
            >
              ...
              {[
                ...
                <div key={key}>
                  ...
                  <input
                    ...
                    className="mt-1 h-13 w-full rounded-2xl border border-[#d0d9d1] bg-white px-4 text-sm outline-none"
                  />
                </div>
              ))}
            </div>
    ...
    {screen === "prediction" && (
      <section className="flex min-h-screen flex-col items-center justify-center px-7 text-center">
        ...
        <div className="mt-8 flex items-center gap-2 text-xs text-[#7d887f]">
          ...
          Predicting waiting time and ranking
          centres
        </div>
      </section>
    )}
        ...
        <section className="min-h-screen px-5 pb-8 pt-5">
          ...
          <div className="mt-8">
            ...
            <button
              ...
              onClick={openBooking}
              className="mt-5 flex h-14 w-full items-center justify-center gap-2 rounded-2xl bg-[#1f513a] text-base font-semibold text-white disabled:opacity-50"
            >
              {bookingLoading
                ? "Loading slots..."
                : "Choose Procurement Slot"}
      ...
      centre && (
        <section className="min-h-screen px-5 pb-8 pt-5">
          ...
          <div className="mt-8">
            ...
            <p className="mt-3 text-sm leading-6 text-[#667169]">
              Select an available slot. The
              token is generated only after
              ...
              {slots.map((slot) => (
                <button
                  ...
                  className={`w-full rounded-2xl border p-4 text-left ${
                    ...
                    slot.slot_id
                      ? "border-[#24543d] bg-[#e9f0e9] ring-2 ring-[#24543d]/10"
                      : "border-[#d5ddd6] bg-white"
                  } disabled:opacity-40`}
                >
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="mt-1 text-xs text-[#6d786f]">
                        {slot.remaining} places remaining
                      </div>
                    </div>

                    {slot.recommended && (
                      <span className="rounded-full bg-[#1f513a] px-2.5 py-1 text-[10px] font-bold text-white">
                        Recommended
                      </span>
                    )}
                  </div>
            ...
            {slots.length === 0 && (
              <div className="mt-6 rounded-2xl bg-[#fff7f4] p-4 text-sm text-[#9a4d36]">
            ...
            <button
              ...
              className="mt-7 h-14 w-full rounded-2xl bg-[#1f513a] text-base font-semibold text-white disabled:opacity-40"
            >
              {bookingLoading
                ? "Confirming booking..."
      ...
      booking && (
        <section className="min-h-screen px-5 pb-8 pt-5">
          ...
          <div className="mt-10 text-center">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[#e4f0e6] text-[#24543d]">
              <span className="h-8 w-8">
                <CheckIcon />
              </span>
            </div>

            <p className="mt-6 text-sm font-semibold uppercase tracking-[0.16em] text-[#b26a27]">
              Booking confirmed
            </p>
            ...
            <div className="mt-7 rounded-[28px] border border-[#b9cdbd] bg-[#e8f0e9] p-6">
              <div className="text-xs font-semibold uppercase tracking-[0.14em] text-[#5c7663]">
                Token number
              </div>

              <div className="mt-2 text-5xl font-black tracking-[0.08em] text-[#18352a]">
                {booking.token}
              </div>
              ...
              <div className="mt-5 grid grid-cols-2 gap-4 text-left text-sm">
                ...
                <div>
                  ...
                  <div className="mt-1 font-bold">
                    {booking.quantity_quintals} qtl
                  </div>
                </div>
              </div>
            </div>

            <div className="mt-5 rounded-2xl border border-[#d5ddd6] bg-white p-4 text-left text-sm leading-6 text-[#5d6961]">
              Keep this token for your
              procurement visit. The operator
              can update its status from{" "}
              <b>Booked</b> through
            ...
            <button
              ...
              className="mt-6 h-14 w-full rounded-2xl bg-[#1f513a] text-base font-semibold text-white"
            >
              Done · Back to Farmer Dashboard
            </button>
          </div>
        </section>
      )}
            ...
            <div className="mt-7 rounded-[26px] border border-[#d5ddd6] bg-white p-5">
              ...
              <div className="mt-6 border-t border-[#e3e8e3] pt-5">
                <p className="text-sm leading-6 text-[#5b675f]">
                  For the prototype, this
                  guidance uses the same
                  procurement signals used by
    ...
    {screen === "no-centre" && (
      <section className="flex min-h-screen flex-col justify-center px-6">
        ...
        <p className="mt-3 text-sm leading-6 text-[#68746c]">
          ...
          procurement centre for the selected
          conditions.
        </p>
        ...
        <div className="mt-10">
          ...
          {booking ? (
            <div className="mt-7 rounded-[24px] border border-[#d5ddd6] bg-white p-5">
              ...
              <div className="mt-3 text-3xl font-black tracking-wide text-[#24543d]">
                {booking.token}
              </div>

              <div className="mt-2 text-sm text-[#68746c]">
                {booking.centre_id} ·{" "}
                {booking.crop} ·{" "}
                {booking.booking_status}
              </div>
              ...
              <button
                ...
                className="mt-5 h-12 w-full rounded-xl bg-[#1f513a] text-sm font-semibold text-white"
              >
                View booking
              </button>
            </div>
            ...
            <div className="mt-7 rounded-[24px] border border-[#d5ddd6] bg-white p-5">
              <h2 className="text-lg font-bold">
                No procurement booking yet
              </h2>

              <p className="mt-2 text-sm leading-6 text-[#68746c]">
                Your confirmed token and
                procurement status will appear
                here after you book a slot.
              </p>
            </div>
          )}
