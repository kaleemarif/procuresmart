...
localStorage.setItem(
  ...
  registeredFarmerId,
      ...
      /*
       * IMPORTANT:
       * TypeScript needs an explicit guard here because
       * farmerId is string | null.
       */
      if (!id) {
        throw new Error("Farmer registration failed.");
      }
        ...
        {screen === "booking" && centre && (
          <section className="min-h-screen px-5 pb-8 pt-5">
            ...
            <div className="mt-8">
              ...
              <p className="mt-3 text-sm leading-6 text-[#667169]">
                Select an available slot. The token
                is generated only after this booking
                is confirmed.
              </p>
          ...
          <section className="min-h-screen px-5 pb-8 pt-5">
            ...
            <div className="mt-10 text-center">
              ...
              <div className="mt-5 rounded-2xl border border-[#d5ddd6] bg-white p-4 text-left text-sm leading-6 text-[#5d6961]">
                ...
                procurement visit. The operator can
                update its status from{" "}
                <b>Booked</b> through procurement and
                payment.
              </div>
