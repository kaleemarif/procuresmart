    ...
    navigator.geolocation.getCurrentPosition(
      ...
      (positionError) => {
        ...
        if (
          ...
          setError(
            "We could not access your location. Please try again or enter it manually."
          );
        }
      },
      {
              ...
              {locationMode === "gps" && (
                <div className="mt-6 rounded-[24px] border border-[#d4ddd5] bg-white p-5">
                  ...
                  <button
                    ...
                    disabled={gpsLoading}
                    className="mt-5 flex h-[52px] w-full items-center justify-center gap-2 rounded-2xl border border-[#bfcfc2] bg-[#f7faf7] text-sm font-semibold text-[#24543d] disabled:opacity-50"
                  >
                    <span className="h-5 w-5">
                      <LocationIcon />
                    </span>
                  ...
                  {gpsLatitude !== null &&
                    gpsLongitude !== null && (
                      <div className="mt-4 rounded-xl bg-[#f1f5f1] p-3 text-xs leading-5 text-[#637068]">
                        Location captured
                        successfully. Distance-aware
                  ...
                  {[
                    ...
                    <div key={key}>
                      ...
                      <input
                        ...
                        className="mt-1 h-[52px] w-full rounded-2xl border border-[#d0d9d1] bg-white px-4 text-sm outline-none focus:border-[#7d9b84]"
                      />
                    </div>
                  ))}

                  <div className="rounded-2xl border border-[#ded8cb] bg-[#fffaf1] p-4 text-xs leading-5 text-[#80633f]">
                    Manual location is currently used
                    as location context only. Distance
                    calculation requires GPS coordinates;
                    ProcureSmart will not invent coordinates
                    from the village or tehsil name.
                  </div>
                </div>
              )}
          ...
          centre && (
            <section className="min-h-screen px-5 pb-8 pt-5">
              ...
              <div className="mt-8">
                ...
                <p className="mt-3 text-sm leading-6 text-[#667169]">
                  Explore the recommended centre,
                  nearby alternatives and their current
                  prototype procurement signals.
                </p>
                ...
                <div className="mt-3 rounded-[24px] border border-[#d5ddd6] bg-white p-5">
                  <div className="text-xs font-semibold uppercase tracking-[0.12em] text-[#7a857d]">
                    Processing information
                  </div>

                  <div className="mt-4 space-y-3 text-sm text-[#4f5c53]">
                    <div className="flex justify-between gap-4">
                      ...
                      <strong>
                        {centre.avg_processing_time} min
                      </strong>
                    </div>
                ...
                <div className="mt-7 rounded-[26px] border border-[#d5ddd6] bg-white p-5">
                  ...
                  <div className="mt-6 border-t border-[#e3e8e3] pt-5">
                    <p className="text-sm leading-6 text-[#5b675f]">
                      ...
                      waiting time for the selected
                      conditions. It does not yet have
                      historical time-slot data, so it
                      does not claim to predict an exact
                      best arrival time.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-4 rounded-[24px] border border-[#d5ddd6] bg-white p-5">
                  ...
                  <div className="mt-4 space-y-3">
                    {[
                      ...
                      "Centre capacity",
                      "Distance from farmer when GPS is available",
                    ].map((item) => (
                      <div
                        key={item}
                        className="flex items-center gap-3"
                      >
                        <span className="h-5 w-5 shrink-0 text-[#24543d]">
                          <CheckIcon />
                        </span>

                        <span className="text-sm text-[#526057]">
                          {item}
                        </span>
                      </div>
                    ))}
